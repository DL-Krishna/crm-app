...
export const createUser = async (req: Request, res: Response): Promise<Response> => {
	const { empCode, username, email, mobile, password, name, role } = req.body;
...
export const loginUser = async (req: Request, res: Response): Promise<Response> => {
	...
	try {
		...
		const token = jwt.sign(
			{ userId: user.id, username: user.username, email: user.email, mobile: user.mobile, role: user.role },
...
export const updateUser = async (req: Request, res: Response): Promise<Response> => {
	...
	const { name, empCode, username, email, mobile, password, role } = req.body;
