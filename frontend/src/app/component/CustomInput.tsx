...
const CustomInput = ({ lableValue, disabled, typeValue, placeholder, onChange, name, value = '', error, accept }: { error?: string | null, value?: any, name?: String, onChange?: (e: any) => void, lableValue: String, typeValue: String, placeholder: String, disabled?: boolean, accept?: string }) => {
