...
const Table = ({ isLoader, initialColumnDefs, datas, searchValue, noDataFoundMsg }: { isLoader?: boolean, initialColumnDefs?: any, datas?: any, searchValue?: string, noDataFoundMsg?: string }) => {
                    ...
                    isLoader ? (
                        ...
                        <div className='relative overflow-auto' style={{ width: "100%" }}>
                            <AgGridReact
                                ...
                                overlayNoRowsTemplate={noDataFoundMsg ? noDataFoundMsg : 'data no found'}
                            />
                        </div>}
            </div>
        </div>
